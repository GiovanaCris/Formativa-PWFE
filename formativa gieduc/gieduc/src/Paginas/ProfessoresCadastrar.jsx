//Cadastro e exlusão dos professores
...
export function ProfessoresCadastrar() {
    ...
    async function obterDadosFormulario(data) {
        try {
            ...
            alert("Professor cadastrado com sucessso!");
            reset();
    ...
    return (
        <div className={estilos.container}>
            <h2 className={estilos.titulocad}>CADASTRAR NOVO PROFESSOR</h2>
